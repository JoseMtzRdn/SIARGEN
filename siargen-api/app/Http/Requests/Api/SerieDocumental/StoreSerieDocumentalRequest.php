...
class StoreSerieDocumentalRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'codigo' => [
                ...
                'string',
                'max:100',
                Rule::unique('series_documentales')->where(fn ($query) => $query->where('seccion_id', $this->seccion_id)),
                'regex:#^[-a-zA-Z0-9._/]+$#'
            ],
            ...
            'acceso' => ['nullable', Rule::in(['Publico', 'Reservado', 'Confidencial'])],
